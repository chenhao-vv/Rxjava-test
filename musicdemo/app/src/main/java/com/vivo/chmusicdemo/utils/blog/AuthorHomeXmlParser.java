...
public class AuthorHomeXmlParser {
    private static final String TAG = "RankReadingXmlParser";

    public static List<Blog> getAuthorHomeInfo(String xmlData) throws IOException, XmlPullParserException {
